...
from .domainnet import DomainNet_fewshot
from dassl.utils import mkdir_if_missing
import pickle


@DATASET_REGISTRY.register()
class TerraIncognita_fewshot(DatasetBase):

    domain_idx = {'location_100':0, 'location_38':1, 'location_43':2, 'location_46':3 }
    ...
    def __init__(self, cfg):
        ...
        if not os.path.exists(self.dir):
            DomainNet_fewshot.generate_image_list(cfg.DATASET.ROOT, self.dir)
